...
<body>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <input type="text" name="" id="inpTahun" placeholder="Tahun" class="inp"
                                                value="{{ date('Y') }}" oninput="tampilkanTahun()">
                                        </div>
                                        <div class="col-lg-5">
                                            <select id="inpBulan" onchange="tampilkanBulan()" class="inp"
                                                value="{{  date('M')  }}">
                                                <option value="semua">semua</option>
                                                <option value="1" {{  (date('m') == 1) ? 'selected' : '' }}>Januari
                                                </option>
                                                <option value="2" {{  (date('m') == 2) ? 'selected' : '' }}>Februari
                                                </option>
                                                <option value="3" {{  (date('m') == 3) ? 'selected' : '' }}>Maret
                                                </option>
                                                <option value="4" {{  (date('m') == 4) ? 'selected' : '' }}>April
                                                </option>
                                                <option value="5" {{  (date('m') == 5) ? 'selected' : '' }}>Mei</option>
                                                <option value="6" {{  (date('m') == 6) ? 'selected' : '' }}>Juni
                                                </option>
                                                <option value="7" {{  (date('m') == 7) ? 'selected' : '' }}>Juli
                                                </option>
                                                <option value="8" {{  (date('m') == 8) ? 'selected' : '' }}>Agustus
                                                </option>
                                                <option value="9" {{  (date('m') == 9) ? 'selected' : '' }}>September
                                                </option>
                            ...
                            <table class="table datatable" id="tableEvent">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($event['status'] == 'diajukan')
                                            <button class="btn btn-lihat" onclick="proses({{ $event['id_event'] }})"><i
                                                    class="bi bi-eye-fill"></i> Lihat</button>
                                            @elseif ($event['status'] == 'proses')
                                            <a href="/event/detail/{{ $event['id_event'] }}" class="btn btn-lihat"><i
    ...
    function getData(con = null) {
        ...
        //open the request
        xhr.open('POST', domain + "/event/pengajuan")
