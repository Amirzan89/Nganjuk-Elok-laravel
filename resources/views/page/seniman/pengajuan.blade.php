...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div class="srcDate">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <input type="text" name="" id="inpTahun" placeholder="Tahun" class="inp"
                                                value="<?php echo date('Y') ?>" oninput="tampilkanTahun()">
                                        </div>
                                        <div class="col-lg-5">
                                            <select id="inpBulan" onchange="tampilkanBulan()" class="inp"
                                                value="<?php echo date('M')  ?>">
                                                <option value="semua">semua</option>
                                                <option value="1" <?php echo (date('m') == 1) ? 'selected' : ''; ?>>
                                                    Januari</option>
                                                <option value="2" <?php echo (date('m') == 2) ? 'selected' : ''; ?>>
                                                    Februari</option>
                                                <option value="3" <?php echo (date('m') == 3) ? 'selected' : ''; ?>>
                                                    Maret</option>
                                                <option value="4" <?php echo (date('m') == 4) ? 'selected' : ''; ?>>
                                                    April</option>
                                                <option value="5" <?php echo (date('m') == 5) ? 'selected' : ''; ?>>Mei
                                                </option>
                                                <option value="6" <?php echo (date('m') == 6) ? 'selected' : ''; ?>>Juni
                                                </option>
                                                <option value="7" <?php echo (date('m') == 7) ? 'selected' : ''; ?>>Juli
                                                </option>
                                                <option value="8" <?php echo (date('m') == 8) ? 'selected' : ''; ?>>
                                                    Agustus</option>
                                                <option value="9" <?php echo (date('m') == 9) ? 'selected' : ''; ?>>
                                                    September</option>
                                                <option value="10" <?php echo (date('m') == 10) ? 'selected' : ''; ?>>
                                                    Oktober</option>
                                                <option value="11" <?php echo (date('m') == 11) ? 'selected' : ''; ?>>
                                                    November</option>
                                                <option value="12" <?php echo (date('m') == 12) ? 'selected' : ''; ?>>
                                                    Desember</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-lihat"
                                                onclick="proses({{ $seniman['id_seniman'] }})"><i
                                                    class="bi bi-eye-fill"></i> Lihat</button>
                                            @elseif ($seniman['status'] == 'proses')
                                            <a href="/seniman/detail/{{ $seniman['id_seniman'] }}"
                                                class="btn btn-lihat"><i class="bi bi-eye-fill"></i> Lihat</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
    ...
    function updateTable(dataT = '') {
        ...
        function getActionButton(status, idSeniman) {
            if (status == 'diajukan') {
                ...
                return `<a href="/seniman/detail/${idSeniman}" class="btn btn-lihat"><i class="bi bi-eye-fill"></i> Lihat</a>`;
            }
            return '';
        }
    }
    ...
    function getData(con = null) {
        ...
        //open the request
        xhr.open('POST', domain + "/seniman/pengajuan")
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    ...
                    window.location.href = "/seniman/detail/" + Id;
                } else {
                    var response = JSON.parse(xhr.responseText);
