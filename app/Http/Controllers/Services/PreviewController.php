...
{
    public function previewEvent(Request $request){
        ...
        $content = Crypt::decrypt(file_get_contents($filePath));
        $contentType = mime_content_type($filePath);
        return response($content)->header('Content-Type', $contentType);
    }
    public function previewSewaTempat(Request $request){
    ...
    public function previewSeniman(Request $request){
    ...
    public function previewPerpanjangan(Request $request){
